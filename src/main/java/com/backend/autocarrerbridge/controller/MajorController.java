...
public class MajorController {
    ...
    public ResponseEntity<ApiResponse<Object>> update(@PathVariable("id") int id, @RequestBody MajorDTO majorDTO) {
    ...
    public ResponseEntity<ApiResponse<Object>> getById(@PathVariable("id") int id) {
        ApiResponse<Object> response =
                new ApiResponse<>().setCode(SUCCESS).setMessage(SUCCESS_MESSAGE).setData(majorService.getMajorById(id));
        return ResponseEntity.ok(response);
    }
    ...
    public ResponseEntity<ApiResponse<Object>> getAll() {
        ApiResponse<Object> response =
                new ApiResponse<>().setCode(SUCCESS).setMessage(SUCCESS_MESSAGE).setData(majorService.getAllMajor());
        return ResponseEntity.ok(response);
    }
}
