...
public class WorkShopController {
     ...
     */
    @GetMapping
    public ApiResponse<Object> getAllWorkShop(@RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "5") Integer size) {
        return ApiResponse.builder().data(workShopService.getAllWorkShop(PageRequest.of(page, size))).build();
    }
    ...
    public ApiResponse<Object> createWorkShop(@ModelAttribute WorkShopRequest workShopRequest) {
        return ApiResponse.builder().data(workShopService.createWorkShop(workShopRequest)).build();
    }
    ...
    public ApiResponse<Object> getAllWorkShopByState(@RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "5") Integer size, @PathVariable("state") State state) {
        return ApiResponse.builder().data(workShopService.getAllWorkShopByState(PageRequest.of(page, size), state)).build();
    }
    ...
    public ApiResponse<Object> getAllWorkShopByUniversity(@RequestParam(defaultValue = "0") Integer page, @RequestParam(defaultValue = "5") Integer size, @PathVariable("universityId") Integer universityId) {
        return ApiResponse.builder().data(workShopService.getAllWorkShopByUniversity(PageRequest.of(page, size), universityId)).build();
    }
    ...
    public ApiResponse<Object> updateWorkShop(@PathVariable("idWorkShop") Integer idWorkShop, @ModelAttribute WorkShopRequest workShopRequest) {
        return ApiResponse.builder().data(workShopService.updateWordShop(idWorkShop, workShopRequest)).build();
    }
    ...
    public ApiResponse<Object> removeWorkShop(@PathVariable("idWorkShop") Integer idWorkShop) {
        return ApiResponse.builder().data(workShopService.removeWorkShop(idWorkShop)).build();
    }
    /**
    ...
    public ApiResponse<Object> getAllAcceptedBusiness(@RequestParam(defaultValue = "0") Integer page,
