...
public interface WorkShopRepository extends JpaRepository<Workshop, Integer> {
  ...
  Page<Workshop> getAllWorkShopByUniversity(
      Pageable pageable, @Param("universityId") Integer universityId,
  ...
  Page<Workshop> getAllWorkShopByLocation(Pageable pageable,
      @Param("idProvinces") Integer idProvinces);
  ...
  Page<WorkshopStateBusiness> findAllWorkShopByBusinessId(@Param("status") Status status,
      @Param("businessId") Integer businessId, @Param("state") State state,
  ...
  @Query(
      "SELECT new com.backend.autocarrerbridge.dto.response.workshop.WorkshopCountResponse(w.title,COUNT(wb))"
          + "FROM Workshop w"
          + " LEFT JOIN WorkshopBusiness wb ON wb.id = wb.workshop.id  AND wb.statusConnected = :state"
          + " WHERE w.university.id = :universityId "
          + " GROUP BY w.title")
  List<WorkshopCountResponse> countWorkshopByApproved(@Param("universityId") Integer universityId,
      @Param("state") State state);
}
