...
/**
 * Service thực hiện các chức năng liên quan đến kết nối giữa Workshop và Business. - Lấy thông tin
 * các doanh nghiệp đã tham gia workshop. - Xử lý yêu cầu tham gia workshop của doanh nghiệp.
 */
@Service
...
public class WorkShopBusinessServiceImpl implements WorkShopBusinessService {
   ...
   */
  public WorkShopBusinessReponse getAllColabBusiness(Integer workshopId, Pageable pageable,
      State state) {
  ...
  /**
   * Chấp nhận kết nối giữa workshop và business. Kiểm tra xem workshop và business có tồn tại và
   * trạng thái hiện tại có phù hợp để chấp nhận không. Nếu đã tồn tại và được phê duyệt trước đó,
   * ném ngoại lệ. Nếu không, cập nhật trạng thái kết nối thành "APPROVED".
   *
  ...
  public List<Map<String, Object>> countWorkShopAndStatusConnected() {
    ...
    for (Workshop workshop : workshops) {
      ...
      long pendingCompanies = workShopBussinessRepository.countByWorkshopAndStatusConnected(workshop,
          State.PENDING);
