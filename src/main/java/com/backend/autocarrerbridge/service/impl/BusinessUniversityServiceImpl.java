...
public class BusinessUniversityServiceImpl implements BusinessUniversityService {
  ...
  public ApiResponse<Object> getSentRequest() throws ParseException {
    ...
    List<SentRequestResponse> sentRequestResponse = sentRequestConverter.toSentRequestResponse(
        universities);
  ...
  public ApiResponse<Object> sendRequest(Integer universityId) throws ParseException {
    ...
    BusinessUniversity existingRelation =
        businessUniversityRepository.findByBusinessIdAndUniversityId(business.getId(),
            universityId);
  ...
  @Override
  public List<CooperationUniversityResponse> getAllCooperationOfUniversityPending()
  ...
  @Override
  public List<CooperationUniversityResponse> getAllCooperationOfUniversityApprove()
      throws ParseException {
  ...
  @Override
  public List<CooperationUniversityResponse> getAllCooperationOfUniversityReject()
      throws ParseException {
  ...
  public void approveRequetCooperation(Integer idBusinessUniversity) {
    BusinessUniversity businessUniversity =
        businessUniversityRepository.findBusinessUniversityById(idBusinessUniversity);
